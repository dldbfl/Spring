			      	  ...
			      	  <div class="card-footer">
			        			<div class="row">
					          		...
					          		<div class="col-sm-3 text-center">
					          			...
					          			<button type="button" id="disabledBtn" class="btn btn-info">정지</button>
					          			</c:if>
					          			<c:if test="${member.enabled eq '0'}">
					          			<button type="button"  id="enabledBtn" class="btn btn-info" >활성</button>
					          			</c:if>
					          		</div>
					          		<div class="col-sm-3 text-center">
		...
		$.ajax({
			...
			success:function(data){
				if(data=="SUCCESS"){
					...
					Swal.fire({
						  icon: 'error',
						  title: '관리자 암호가 일치하지 않아요.', 
						 /*   text: '관리자 암호가 일치하지 않아요.',  */
						  footer: '<a href>비밀번호를 잊으셨나요?</a>'
						})
